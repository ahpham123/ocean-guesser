    ...
    <main className="relative min-h-screen flex flex-col items-center justify-center text-white px-4 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <button
          ...
          className="px-10 py-5 rounded-2xl bg-[#42bda0] hover:bg-[#68cab3] transition-all hover:scale-105 duration-300 text-white text-center cursor-pointer"
        >
        ...
        <button
          ...
          className="px-10 py-5 rounded-2xl bg-[#2f2bd4] hover:bg-[#5855dd] transition-all hover:scale-105 text-white text-center cursor-pointer"
        >
